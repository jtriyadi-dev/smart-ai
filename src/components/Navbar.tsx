      ...
      <div className="w-full max-w-7xl mx-auto px-3 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between gap-2">
          ...
          <button
            ...
            className="flex items-center gap-2 sm:gap-3 group text-left cursor-pointer focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-cyan-400 rounded-lg p-0.5 sm:p-1 shrink-0"
          >
            <div className="relative flex items-center justify-center w-8 h-8 sm:w-10 sm:h-10 rounded-xl bg-gradient-to-br from-cyan-500 via-blue-600 to-indigo-600 p-[1px] shadow-md shadow-cyan-500/20 group-hover:shadow-cyan-500/40 transition-all shrink-0">
              <div className="w-full h-full bg-[#090d16] rounded-[11px] flex items-center justify-center">
                <Bot className="w-4 h-4 sm:w-5 sm:h-5 text-cyan-400 group-hover:rotate-12 transition-transform duration-300" />
              </div>
            ...
            <div className="flex flex-col justify-center">
              <div className="font-display font-extrabold text-base sm:text-xl tracking-wider text-white group-hover:text-cyan-300 transition-colors whitespace-nowrap leading-none">
                SMART-AI<span className="text-cyan-400">.ID</span>
              </div>
              <div className="text-[8px] sm:text-[10px] tracking-wider sm:tracking-widest text-slate-400 uppercase font-mono whitespace-nowrap leading-tight mt-0.5">
                Enterprise AI &amp; Web
              </div>
            </div>
          </button>
